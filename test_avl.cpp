...
int main() {
    ...
    assert(del(c, 123));
    container_verify(c, {});
    std::cout << "quick tests passed" << std::endl;
    ...
    std::cout << "sequentail insertion passed" << std::endl;
    ...
    std::cout << "random insertion passed" << std::endl;
    ...
    std::cout << "random deletion passed" << std::endl;
    ...
    std::cout << "insertion/deletion random passed" << std::endl;

    dispose(c);
    std::cout << "disposed successfully" << std::endl;
    return 0;
}